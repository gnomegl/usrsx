...
func init() {
	...
	rootCmd.Flags().StringVarP(&config.CSVPath, "csv-output", "co", "", "Export to CSV file (path required)")
	...
	rootCmd.Flags().StringVarP(&config.JSONPath, "json-output", "jo", "", "Export to JSON file (path required)")
